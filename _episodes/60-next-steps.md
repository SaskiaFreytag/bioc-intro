...
~~~
DataFrame with 0 rows and 10 columns
~~~
{: .output}
...
> > # A tibble: 0 × 25
> > # Groups:   .sample [0]
> > # … with 25 variables: .feature <chr>, .sample <chr>, counts <int>,
> > #   title <chr>, geo_accession <chr>, organism <chr>, age <chr>, sex <fct>,
> > #   infection <fct>, strain <chr>, time <fct>, tissue <fct>, mouse <fct>,
> > #   center <chr>, gene <chr>, ENTREZID <chr>, product <chr>, gbkey <chr>,
> > #   external_gene_name <chr>, ensembl_gene_id <chr>, external_synonym <chr>,
> > #   chromosome_name <chr>, gene_biotype <chr>, phenotype_description <chr>,
